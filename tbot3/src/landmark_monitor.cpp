...
// private:
//   /* attributes */
// //   std::map<std::string, Landmark> landmarks_list;
// //   double robot_x;          // to get these values listen odom topic
// //   double robot_y;          // for this use the subscribe functionality of ros node

// public:
//   /* class constructors & destrcutors */
//   LandmarkMonitor();
// //   LandmarkMonitor():
// //     landmarks_list(), robot_x{0}, robot_y{0} {
// //         landmarks_list = { 
...
//   /* class methods to implement service callback */
...
//     //check if the landmark exit or not
//     // if(landmarks_list.find(request.name) == landmarks_list.end()){
//     //     ROS_ERROR("Unknown Landmarks [%s]", request.name.c_str());
//     // }
//     return true;
//   }
  
//   /* class methods to implement subscribe callback
//    * created to get the x and y position of the robot from the odom topic
//   */
...
// LandmarkMonitor ::LandmarkMonitor(/* args */)
// {
// }
...
//   //instance of the class LandmarkMontior
//   LandmarkMonitor monitor;
//   //create services and hook them up with the callback function defined above as method of the class
...
//   //create subscriber and hool them with the callback funtion defined above as method od the class
